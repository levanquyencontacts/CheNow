...
export class ConversationsController {
  ...
  @Patch(':id/assign')
  assign(@Param('id') id: string, @Request() request: AuthRequest) {
    return this.conversationsService.assign(Number(id), request.user);
  }

  @Patch(':id/unassign')
  unassign(@Param('id') id: string, @Request() request: AuthRequest) {
    return this.conversationsService.unassign(Number(id), request.user);
  }
